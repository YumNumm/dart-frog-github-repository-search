...
SearchResponseItem _$SearchResponseItemFromJson(Map<String, dynamic> json) {
  return _SearchResponseItem.fromJson(json);
}
...
abstract class $SearchResponseItemCopyWith<$Res> {
  ...
  $SearchResponseOwnerCopyWith<$Res> get owner;
}
...
class _$SearchResponseItemCopyWithImpl<$Res, $Val extends SearchResponseItem>
  ...
  $SearchResponseLicenseCopyWith<$Res>? get license {
    ...
    return $SearchResponseLicenseCopyWith<$Res>(_value.license!, (value) {
  ...
  @pragma('vm:prefer-inline')
  $SearchResponseOwnerCopyWith<$Res> get owner {
    return $SearchResponseOwnerCopyWith<$Res>(_value.owner, (value) {
...
/// @nodoc
@JsonSerializable()
class _$SearchResponseItemImpl implements _SearchResponseItem {
  const _$SearchResponseItemImpl(
      {required this.id,
  ...
  factory _$SearchResponseItemImpl.fromJson(Map<String, dynamic> json) =>
      _$$SearchResponseItemImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$SearchResponseItemImplToJson(
      this,
    );
  }
}

abstract class _SearchResponseItem implements SearchResponseItem {
  const factory _SearchResponseItem(
  ...
  factory _SearchResponseItem.fromJson(Map<String, dynamic> json) =
      _$SearchResponseItemImpl.fromJson;
